...
@media only screen and (-webkit-min-device-pixel-ratio: 1.5),
	...
	****************************************/
	...
	$universal_font_color = dynamik_get_design( 'universal_font_color' );
	$universal_link_color = dynamik_get_design( 'universal_link_color' );
	$universal_link_hover_color = dynamik_get_design( 'universal_link_hover_color' );
	$universal_line_height = dynamik_get_design( 'universal_line_height' );
	$body_font_size = dynamik_build_font_size( 'body' );
	
	if( dynamik_get_design( 'universal_link_underline' ) == 'On Hover' )
	{
		$universal_link_underline_visited = 'none';
		$universal_link_underline_hover = 'underline';
	}
	elseif( dynamik_get_design( 'universal_link_underline' ) == 'Off Hover' )
	{
		$universal_link_underline_visited = 'underline';
		$universal_link_underline_hover = 'none';
	}
	elseif( dynamik_get_design( 'universal_link_underline' ) == 'Always' )
	{
		$universal_link_underline_visited = 'underline';
		$universal_link_underline_hover = 'underline';
	}
...
.full-width-content ' . dynamik_html_markup( 'site_container' ) . ' {
	...
	$universal_font_css = '';
	if( dynamik_get_design( 'universal_font_css' ) )
	{
		$universal_font_css = dynamik_get_design( 'universal_font_css' );
	}
	
	$body_font_css = '';
	if( dynamik_get_design( 'body_font_css' ) && empty( $universal_font_css ) )
	{
		$body_font_css = dynamik_get_design( 'body_font_css' );
	}
	
	$title_font_css = '';
	if( dynamik_get_design( 'title_font_css' ) )
	{
		$title_font_css = dynamik_get_design( 'title_font_css' );
	}
	
	$tagline_font_css = '';
	if( dynamik_get_design( 'tagline_font_css' ) )
	{
		$tagline_font_css = dynamik_get_design( 'tagline_font_css' );
	}
	
	$nav1_font_css = '';
	if( dynamik_get_design( 'nav1_font_css' ) )
	{
		$nav1_font_css = dynamik_get_design( 'nav1_font_css' );
	}
	
	$nav1_extras_font_css = '';
	if( dynamik_get_design( 'nav1_extras_font_css' ) )
	{
		$nav1_extras_font_css = dynamik_get_design( 'nav1_extras_font_css' );
	}
	
	$nav2_font_css = '';
	if( dynamik_get_design( 'nav2_font_css' ) )
	{
		$nav2_font_css = dynamik_get_design( 'nav2_font_css' );
	}
	
	$nav3_font_css = '';
	if( dynamik_get_design( 'nav3_font_css' ) )
	{
		$nav3_font_css = dynamik_get_design( 'nav3_font_css' );
	}
	
	$content_heading_font_css = '';
	if( dynamik_get_design( 'content_heading_font_css' ) )
	{
		$content_heading_font_css = dynamik_get_design( 'content_heading_font_css' );
	}
	
	$content_byline_font_css = '';
	if( dynamik_get_design( 'content_byline_font_css' ) )
	{
		$content_byline_font_css = dynamik_get_design( 'content_byline_font_css' );
	}
	
	$content_p_font_css = '';
	if( dynamik_get_design( 'content_p_font_css' ) )
	{
		$content_p_font_css = dynamik_get_design( 'content_p_font_css' );
	}
	
	$breadcrumbs_font_css = '';
	if( dynamik_get_design( 'breadcrumbs_font_css' ) )
	{
		$breadcrumbs_font_css = dynamik_get_design( 'breadcrumbs_font_css' );
	}
	
	$taxonomy_box_heading_font_css = '';
	if( dynamik_get_design( 'taxonomy_box_heading_font_css' ) )
	{
		$taxonomy_box_heading_font_css = dynamik_get_design( 'taxonomy_box_heading_font_css' );
	}
	
	$taxonomy_box_content_font_css = '';
	if( dynamik_get_design( 'taxonomy_box_content_font_css' ) )
	{
		$taxonomy_box_content_font_css = dynamik_get_design( 'taxonomy_box_content_font_css' );
	}
	
	$author_box_title_font_css = '';
	if( dynamik_get_design( 'author_box_title_font_css' ) )
	{
		$author_box_title_font_css = dynamik_get_design( 'author_box_title_font_css' );
	}
	
	$author_box_font_css = '';
	if( dynamik_get_design( 'author_box_font_css' ) )
	{
		$author_box_font_css = dynamik_get_design( 'author_box_font_css' );
	}
	
	$post_nav_font_css = '';
	if( dynamik_get_design( 'post_nav_font_css' ) )
	{
		$post_nav_font_css = dynamik_get_design( 'post_nav_font_css' );
	}
	
	$blockquote_font_css = '';
	if( dynamik_get_design( 'blockquote_font_css' ) )
	{
		$blockquote_font_css = dynamik_get_design( 'blockquote_font_css' );
	}
	
	$caption_font_css = '';
	if( dynamik_get_design( 'caption_font_css' ) )
	{
		$caption_font_css = dynamik_get_design( 'caption_font_css' );
	}
	
	$post_meta_font_css = '';
	if( dynamik_get_design( 'post_meta_font_css' ) )
	{
		$post_meta_font_css = dynamik_get_design( 'post_meta_font_css' );
	}
	
	$ez_widget_home_title_font_css = '';
	if( dynamik_get_design( 'ez_widget_home_title_font_css' ) )
	{
		$ez_widget_home_title_font_css = dynamik_get_design( 'ez_widget_home_title_font_css' );
	}
	
	$ez_widget_home_content_font_css = '';
	if( dynamik_get_design( 'ez_widget_home_content_font_css' ) )
	{
		$ez_widget_home_content_font_css = dynamik_get_design( 'ez_widget_home_content_font_css' );
	}
	
	$ez_widget_feature_title_font_css = '';
	if( dynamik_get_design( 'ez_widget_feature_title_font_css' ) )
	{
		$ez_widget_feature_title_font_css = dynamik_get_design( 'ez_widget_feature_title_font_css' );
	}
	
	$ez_widget_feature_content_font_css = '';
	if( dynamik_get_design( 'ez_widget_feature_content_font_css' ) )
	{
		$ez_widget_feature_content_font_css = dynamik_get_design( 'ez_widget_feature_content_font_css' );
	}
	
	$ez_widget_footer_title_font_css = '';
	if( dynamik_get_design( 'ez_widget_footer_title_font_css' ) )
	{
		$ez_widget_footer_title_font_css = dynamik_get_design( 'ez_widget_footer_title_font_css' );
	}
	
	$ez_widget_footer_content_font_css = '';
	if( dynamik_get_design( 'ez_widget_footer_content_font_css' ) )
	{
		$ez_widget_footer_content_font_css = dynamik_get_design( 'ez_widget_footer_content_font_css' );
	}
	
	$featured_widget_heading_font_css = '';
	if( dynamik_get_design( 'featured_widget_heading_font_css' ) )
	{
		$featured_widget_heading_font_css = dynamik_get_design( 'featured_widget_heading_font_css' );
	}
	
	$featured_widget_p_font_css = '';
	if( dynamik_get_design( 'featured_widget_p_font_css' ) )
	{
		$featured_widget_p_font_css = dynamik_get_design( 'featured_widget_p_font_css' );
	}
	
	$featured_widget_byline_font_css = '';
	if( dynamik_get_design( 'featured_widget_byline_font_css' ) )
	{
		$featured_widget_byline_font_css = dynamik_get_design( 'featured_widget_byline_font_css' );
	}
	
	$dynamik_widget_title_font_css = '';
	if( dynamik_get_design( 'dynamik_widget_title_font_css' ) )
	{
		$dynamik_widget_title_font_css = dynamik_get_design( 'dynamik_widget_title_font_css' );
	}
	
	$dynamik_widget_content_font_css = '';
	if( dynamik_get_design( 'dynamik_widget_content_font_css' ) )
	{
		$dynamik_widget_content_font_css = dynamik_get_design( 'dynamik_widget_content_font_css' );
	}
	
	$sb_heading_font_css = '';
	if( dynamik_get_design( 'sb_heading_font_css' ) )
	{
		$sb_heading_font_css = dynamik_get_design( 'sb_heading_font_css' );
	}
	
	$sb_content_font_css = '';
	if( dynamik_get_design( 'sb_content_font_css' ) )
	{
		$sb_content_font_css = dynamik_get_design( 'sb_content_font_css' );
	}
	...
	{
		$footer_font_css = dynamik_get_design( 'footer_font_css' );
	}
	
	$search_form_font_css = '';
	if( dynamik_get_design( 'search_form_font_css' ) )
	{
		$search_form_font_css = dynamik_get_design( 'search_form_font_css' );
	}
	
	$search_button_font_css = '';
	if( dynamik_get_design( 'search_button_font_css' ) )
	{
		$search_button_font_css = dynamik_get_design( 'search_button_font_css' );
	}
	...
	elseif( dynamik_get_responsive( 'navbar_media_query_default' ) == 'tablet_dropdown' )
	{
		if( true == dynamik_get_responsive( 'navbar_media_query_delayed' ) )
		{
			...
			$navbar_mq_fourth .= '#dropdown-nav-wrap, #dropdown-subnav-wrap { display: block; }' . "\n";
			$navbar_mq_fifth = '';
			$navbar_mq_sixth = '';
		}
		else
		{
			...
			$navbar_mq_first .= '#dropdown-nav-wrap, #dropdown-subnav-wrap { display: block; }' . "\n";
			$navbar_mq_second = '';
			$navbar_mq_third = '';
			$navbar_mq_fourth = '';
			$navbar_mq_fifth = '';
	...
	elseif( dynamik_get_responsive( 'navbar_media_query_default' ) == 'mobile_dropdown' )
	{
		if( true == dynamik_get_responsive( 'navbar_media_query_delayed' ) )
		{
			...
			$navbar_mq_fifth = '';
			$navbar_mq_sixth = dynamik_html_markup( 'nav_primary' ) . ', ' . dynamik_html_markup( 'nav_secondary' ) . ' { display: none; }' . "\n";
			$navbar_mq_sixth .= '#dropdown-nav-wrap, #dropdown-subnav-wrap { display: block; }' . "\n";
		}
		else
		{
			$navbar_mq_first = 'body.override .menu-primary, body.override .menu-secondary, ' . dynamik_html_markup( 'site_header' ) . ' .widget-area, ' . dynamik_html_markup( 'site_header' ) . ' .genesis-nav-menu { width: 100%; }' . "\n";
...
.ez-only {
	...
	if( dynamik_get_custom_css( 'custom_css' ) == '' )
	{
	...
	$css = dynamik_import_google_fonts() .
'
...
.author-description {
	...
	font-size: ' . $taxonomy_box_content_font_size . ';
	' . $taxonomy_box_content_font_css . '
}
...
' . dynamik_html_markup( 'author_box_content' ) . ' {
	...
	font-size: ' . $author_box_font_size . ';
	' . $author_box_font_css . '
}
...
.featuredpost .post p {
	...
	font-size: ' . $featured_widget_p_font_size . ';
	' . $featured_widget_p_font_css . '
}
...
.featuredpost .post ' . dynamik_html_markup( 'entry_header_entry_meta' ) . ' {
	...
	font-size: ' . $featured_widget_byline_font_size . ' !important;
	' . $featured_widget_byline_font_css . '
}
...
' . dynamik_html_markup( 'search_form_search' ) . ', #subbox {
	' . $search_form_bg . '
...
' . dynamik_html_markup( 'search_form_submit' ) . ', #subbutton {
	' . $search_button_bg . '
	...
	line-height: 19px;
	cursor: pointer;
	text-decoration: ' . $search_button_link_underline_visited . ';
	' . $search_button_font_css . '
}

' . dynamik_html_markup( 'search_form_submit' ) . ':hover, #subbutton:hover {
...
#commentform #submit {
	...
	line-height: 19px;
	cursor: pointer;
	text-decoration: ' . $comment_submit_link_underline_visited . ';
	' . $comment_submit_font_css . '
}
...
a.comment-reply-link:visited {
	...
	font-weight: 300;
	text-decoration: ' . $comment_reply_text_link_underline_visited . ';
	' . $comment_reply_text_font_css . '
}
...
#respond p.form-allowed-tags {
	...
	font-size: ' . $comment_form_allowed_tags_font_size . ';
	' . $comment_form_allowed_tags_font_css . '
}
...
//end lib/functions/dynamik-build-styles.php