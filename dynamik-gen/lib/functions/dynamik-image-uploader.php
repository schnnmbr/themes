...
function listimages()
{
	...
	$dir_handle = is_dir( $dynamik_uploader_settings['uploadpath'] ) ? opendir( $dynamik_uploader_settings['uploadpath'] ) : $images_path_broken = true;
...
//end lib/functions/dynamik-image-uploader.php