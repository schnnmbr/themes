 ...
 * @since 1.2
 */
function dynamik_sanatize_string( $string = '' )
{
...
//add_action( 'after_setup_theme', 'dynamik_require_custom_functions_file' );
/**
 * Require the Dynamik Custom Functions file only on the
 * site's front-end and only if it exists.
 *
 * @since 1.0
 *
...
//end lib/functions/dynamik-functions.php