...
jQuery(document).ready(function($){
	...
	function show_message(response) {
		...
		$('#dynamik-custom-saved').html(response).center().fadeIn('slow');
	...
	$('.add-template').click(function () { 
		template_counter += 1;
		$('#dynamik-templates-wrap').prepend('<div id="template-' + template_counter + '"><div class="dynamik-custom-template-option"><p class="bg-box-design">' + e_file_name + ' <input type="text" id="custom-template-id-' + template_counter + '" name="custom_template_ids[' + template_counter + ']" value="" style="width:180px;" class="forbid-template-chars forbid-caps forbid-names" />.php | ' + e_template_name + ' <input type="text" id="custom-template-name-' + template_counter + '" name="custom_template_names[' + template_counter + ']" value="" style="width:180px;" />  ' + e_template_type + ' <select id="custom-template-type-' + template_counter + '" name="custom_template_types[' + template_counter + ']" ><option value="page_template">' + e_page_template + '</option><option value="wp_template">' + e_wp_template + '</option></select></p><p style="float:right;"><span id="' + template_counter + '" class="button delete-template">' + e_delete + '</span><span class="do-shortcode button" style="margin-right:192px !important;">' + e_do_shortcode + '</span></p><p style="padding-top:3px;"><textarea class="resizable dynamik-tabby-textarea dynamik-tabby-textarea-temp" id="custom-template-textarea-' + template_counter + '" name="custom_template_textarea[' + template_counter + ']" style="width:780px;height:100px;text-align:left;margin-top:4px !important;"></textarea></p></div></div>');
	});
	...
	$('.add-label').click(function () { 
		label_counter += 1;
		$('#dynamik-labels-wrap').prepend('<div id="label-' + label_counter + '"><div class="dynamik-custom-label-option"><p class="bg-box-design">' + e_name + ' <input type="text" id="custom-label-name-' + label_counter + '" name="custom_label_names[' + label_counter + ']" value="" style="width:140px;" /> ( ' + e_label_create_conditional + ' <input type="checkbox" id="custom-label-create-conditional-' + label_counter + '" name="custom_label_create_conditionals[' + label_counter + ']" value="1" /> ) <span id="' + label_counter + '" class="button delete-label">' + e_delete + '</span></p></div></div>');
	});
	...
	$('.add-conditional').click(function () { 
		...
		$('#dynamik-conditionals-wrap').prepend('<div id="conditional-' + conditional_counter + '"><div class="dynamik-custom-conditional-option-desc"><p><select id="id-custom-conditional-id-' + conditional_counter + '" class="conditional-examples id-custom-conditional-tag-' + conditional_counter + '" name="conditional_examples" size="1" style="width:165px;">' + f_dynamik_list_conditional_examples + '</select></p></div><div class="dynamik-custom-conditional-option"><p class="bg-box-design">' + e_name + ' <input type="text" id="custom-conditional-id-' + conditional_counter + '" name="custom_conditional_ids[]" value="" style="width:190px;" class="forbid-chars forbid-caps" /> ' + e_tag + ' <input type="text" id="custom-conditional-tag-' + conditional_counter + '" name="custom_conditional_tags[]" value="" style="width:240px;" /><span id="' + conditional_counter + '"class="button delete-conditional">' + e_delete + '</span></p></div></div>');
	});
	...
	$('.add-widget').click(function () { 
		widget_counter += 1;
		$('#dynamik-widgets-wrap').prepend('<div id="widget-' + widget_counter + '"><div class="dynamik-custom-widget-option"><p class="bg-box-design"><span>' + e_name + '</span> <input type="text" id="custom-widget-id-' + widget_counter + '" name="custom_widget_ids[' + widget_counter + ']" value="" style="width:275px;" class="forbid-chars forbid-caps" /> <span>' + e_hook + '</span> <select id="custom-widget-hook-' + widget_counter + '" name="custom_widget_hook[' + widget_counter + ']" size="1" style="width:250px;">' + f_dynamik_list_hooks + '</select> <span>' + e_priority + '</span> <input type="text" id="custom-widget-priority-' + widget_counter + '" name="custom_widget_priority[' + widget_counter + ']" value="10" style="width:30px;" /> | <select id="custom-widget-status-' + widget_counter + '" class="custom-widget-status" name="custom_widget_status[' + widget_counter + ']" ><option value="hkd">' + e_hooked + '</option><option value="sht">' + e_shortcode + '</option><option value="bth">' + e_both + '</option><option value="no">' + e_deactivate + '</option></select> </p><p><span>' + e_conditionals + '</span> <select class="conditionals-list-multiselect" id="custom-widget-conditionals-list-' + widget_counter + '" name="custom_widget_conditionals_list[' + widget_counter + '][]" multiple="multiple" style="width:250px;">' + f_dynamik_list_conditionals + '</select> <span>' + e_class + '</span> <input type="text" id="custom-widget-class-' + widget_counter + '" name="custom_widget_class[' + widget_counter + ']" value="" style="width:250px;" /> <span id="' + widget_counter + '" class="button delete-widget">' + e_delete + '</span></p></div></div>' );
	...
	$('.wrap').on('change', '.custom-widget-status', function() {
		...
		if(value == 'sht') {
			$('#widget-' + this_id_number + ' span:contains("Name")').css('opacity', '1');
			$('#widget-' + this_id_number + ' span:contains("Hook")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Priority")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Class")').css('opacity', '1');
			...
			$('#widget-' + this_id_number + ' span:contains("Name")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Hook")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Priority")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '0.2');
			$('#widget-' + this_id_number + ' span:contains("Class")').css('opacity', '0.2');
			...
			$('#widget-' + this_id_number + ' span:contains("Name")').css('opacity', '1');
			$('#widget-' + this_id_number + ' span:contains("Hook")').css('opacity', '1');
			$('#widget-' + this_id_number + ' span:contains("Priority")').css('opacity', '1');
			$('#widget-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '1');
			$('#widget-' + this_id_number + ' span:contains("Class")').css('opacity', '1');
			$('#custom-widget-id-' + this_id_number).removeClass('disabled-form-element');
	...
	$('.add-hook').click(function () { 
		hook_counter += 1;
		$('#dynamik-hooks-wrap').prepend('<div id="hook-' + hook_counter + '"><div class="dynamik-custom-hook-option"><p class="bg-box-design"><span>' + e_name + '</span> <input type="text" id="custom-hook-id-' + hook_counter + '" name="custom_hook_ids[' + hook_counter + ']" value="" style="width:275px;" class="forbid-chars forbid-caps" /> <span>' + e_hook + '</span> <select id="custom-hook-hook-' + hook_counter + '" name="custom_hook_hook[' + hook_counter + ']" size="1" style="width:250px;">' + f_dynamik_list_hooks + '</select> <span>' + e_priority + '</span> <input type="text" id="custom-hook-priority-' + hook_counter + '" name="custom_hook_priority[' + hook_counter + ']" value="10" style="width:30px;" /> |  <select id="custom-hook-status-' + hook_counter + '" class="custom-hook-status" name="custom_hook_status[' + hook_counter + ']" ><option value="hkd">' + e_hooked + '</option><option value="sht">' + e_shortcode + '</option><option value="bth">' + e_both + '</option><option value="css">' + e_css + '</option><option value="no">' + e_deactivate + '</option></select></p><p><span>' + e_conditionals + '</span> <select class="conditionals-list-multiselect" id="custom-hook-conditionals-list-' + hook_counter + '" name="custom_hook_conditionals_list[' + hook_counter + '][]" multiple="multiple" style="width:250px;">' + f_dynamik_list_conditionals + '</select> <span id="' + hook_counter + '" class="button delete-hook">' + e_delete + '</span><span class="do-shortcode button" style="margin-right:192px !important;">' + e_do_shortcode + '</span></p><p><textarea class="resizable dynamik-tabby-textarea dynamik-tabby-textarea-temp" id="custom-hook-textarea-' + hook_counter + '" name="custom_hook_textarea[' + hook_counter + ']" style="width:780px;height:100px;text-align:left;"></textarea></p></div></div>');
	...
	$('.wrap').on('change', '.custom-hook-status', function() {
		...
		if(value == 'sht') {
			$('#hook-' + this_id_number + ' span:contains("Name")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Hook")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Priority")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Hook Box")').css('opacity', '1');
			...
			$('#hook-' + this_id_number + ' span:contains("Name")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Hook")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Priority")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Hook Box")').css('opacity', '1');
			$('#custom-hook-id-' + this_id_number).removeClass('disabled-form-element');
			$('#custom-hook-hook-' + this_id_number).addClass('disabled-form-element');
			...
			$('#hook-' + this_id_number + ' span:contains("Name")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Hook")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Priority")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '0.2');
			$('#hook-' + this_id_number + ' span:contains("Hook Box")').css('opacity', '1');
			...
			$('#hook-' + this_id_number + ' span:contains("Name")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Hook")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Priority")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Conditionals")').css('opacity', '1');
			$('#hook-' + this_id_number + ' span:contains("Hook Box")').css('opacity', '1');
			$('#custom-hook-id-' + this_id_number).removeClass('disabled-form-element');
