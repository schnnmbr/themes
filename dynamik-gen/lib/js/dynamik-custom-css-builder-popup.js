...
jQuery(document).ready(function($) {
	...
	var custom_css_echo_value = $("#custom-css-echo").text()+"";
	custom_css_echo_value.replace(/url\(\images/g, cssBuilderImagesUrl);
	var custom_css_echo_val = $("#custom-css-echo").text();
	$("#custom-css-echo").text(custom_css_echo_val.replace(/url\(\images/g, cssBuilderImagesUrl));
	
	var media_query_custom_css_echo_value = $("#media-query-custom-css-echo").text()+"";
	media_query_custom_css_echo_value.replace(/url\(\images/g, cssBuilderImagesUrl);
	var media_query_custom_css_echo_val = $("#media-query-custom-css-echo").text();
	$("#media-query-custom-css-echo").text(media_query_custom_css_echo_val.replace(/url\(\images/g, cssBuilderImagesUrl));
	/***
	...
	function css_editor_activate() {
		...
		function css_builder_custom_css_change2() {
			...
			var value = $("#css-builder-custom-css-style").text()+"";
			value.replace(/url\(\images/g, cssBuilderImagesUrl);
			var val = $("#css-builder-custom-css-style").text();
			$("#css-builder-custom-css-style").text(val.replace(/url\(\images/g, cssBuilderImagesUrl));
		}
	...
	function css_builder_activate() {
		...
		function css_builder_element_labels_append() {
			...
			$(cssBtabsSiteInner).css('position', 'relative').append('<img id="inner-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/inner-elements-label.png" title="inner" />');
			$(cssBtabsSiteHeader).css('position', 'relative').append('<img id="header-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/header-elements-label.png" title="#header" />');
			$(cssBtabsSiteHeader+' .genesis-nav-menu').css('position', 'relative').append('<img id="header-menu-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/header-menu-elements-label.png" title="#header .genesis-nav-menu, #header .genesis-nav-menu a" />');
			$(cssBtabsNavPrimary).css('position', 'relative').append('<img id="nav-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/nav-elements-label.png" title="#nav" />');
			$(cssBtabsNavSecondary).css('position', 'relative').append('<img id="subnav-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/subnav-elements-label.png" title="#subnav" />');
			...
			$(cssBtabsContent).css('position', 'relative').append('<img id="content-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/content-elements-label.png" title="#content" />');
			...
			$(cssBtabsSidebarPrimary).css('position', 'relative').append('<img id="sidebar-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/sidebar-elements-label.png" title="#sidebar" />');
			$(cssBtabsSidebarSecondary).css('position', 'relative').append('<img id="sidebar-alt-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/sidebar-alt-elements-label.png" title="#sidebar-alt" />');
			$(cssBtabsSiteFooter).css('position', 'relative').append('<img id="footer-label" class="element-labels" src="'+cssBuilderLabelsUrl+'/footer-elements-label.png" title="#footer" />');
		...
		function css_builder_css_change2() {
			...
			var value = $("#css-builder-editor-css-style").text()+"";
			value.replace(/url\(\images/g, cssBuilderImagesUrl);
			var val = $("#css-builder-editor-css-style").text();
			$("#css-builder-editor-css-style").text(val.replace(/url\(\images/g, cssBuilderImagesUrl));
		}
