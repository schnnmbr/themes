	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-author-box-title-font-size" name="dynamik[author_box_title_font_size]" value="<?php dynamik_design_options_defaults( true, 'author_box_title_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-heading-font-css-child" id="dynamik-author-box-title-font-css" name="dynamik[author_box_title_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'author_box_title_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-author-box-font-size" name="dynamik[author_box_font_size]" value="<?php dynamik_design_options_defaults( true, 'author_box_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-author-box-font-css" name="dynamik[author_box_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'author_box_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-author-box-border-thickness" name="dynamik[author_box_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'author_box_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-author-box-avatar-border-thickness" name="dynamik[author_box_avatar_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'author_box_avatar_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
