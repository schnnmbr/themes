	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-breadcrumbs-font-size" name="dynamik[breadcrumbs_font_size]" value="<?php dynamik_design_options_defaults( true, 'breadcrumbs_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-breadcrumbs-font-css" name="dynamik[breadcrumbs_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'breadcrumbs_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-breadcrumbs-border-thickness" name="dynamik[breadcrumbs_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'breadcrumbs_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
