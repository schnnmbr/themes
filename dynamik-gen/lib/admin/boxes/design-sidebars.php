	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-sb-heading-font-size" name="dynamik[sb_heading_font_size]" value="<?php dynamik_design_options_defaults( true, 'sb_heading_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-heading-font-css-child" id="dynamik-sb-heading-font-css" name="dynamik[sb_heading_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'sb_heading_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-sb-content-font-size" name="dynamik[sb_content_font_size]" value="<?php dynamik_design_options_defaults( true, 'sb_content_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-sb-content-font-css" name="dynamik[sb_content_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'sb_content_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-sb-heading-border-thickness" name="dynamik[sb_heading_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'sb_heading_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-sb-content-border-thickness" name="dynamik[sb_content_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'sb_content_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-sb-li-bottom-border-thickness" name="dynamik[sb_li_bottom_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'sb_li_bottom_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
