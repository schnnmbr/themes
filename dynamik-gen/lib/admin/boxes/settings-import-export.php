...
?>
	...
	<div class="dynamik-optionbox-inner-1col">
		<h3 style="border:none; border-bottom:1px solid #F0F0F0; -webkit-box-shadow:none; box-shadow:none;"><?php _e( 'Dynamik Settings/Custom Import/Export', 'dynamik' ); ?></h3>
		
		<div style="width:792px; float:left; padding:10px 10px 10px 0;">
			<div style="width:50%; float:left;">
				<form method="post">
				<div class="bg-box" style="margin-right:0; margin-bottom:0; height:295px;">
					<h4><?php _e( 'Export Settings/Custom Options', 'dynamik' ); ?></h4>
					<p>
						<input type="checkbox" id="export-settings" name="export_settings" value="1" checked /> <?php _e( 'Theme Settings', 'dynamik' ); ?> <strong style="float:right; width:190px;"><?php _e( 'Export File Name:', 'dynamik' ); ?></strong><input type="text" id="dynamik-export-name" name="dynamik_export_name" value="" style="float:right; width:190px;" class="forbid-chars" />
					</p>
					<p>
					...
					<p>
						<input type="checkbox" id="export-hooks" name="export_hooks" value="1" checked /> <?php _e( 'Custom Hook Boxes', 'dynamik' ); ?> <input type="submit" name="clicked_button" value="<?php _e( 'Export Custom Options', 'dynamik' ); ?>" style="margin:-5px 0 0 !important; float:right !important;" class="button-highlighted button"/>
			...
			<div style="width:50%; float:right;">
				...
				<div class="bg-box" style="margin-right:0; margin-bottom:0; height:295px;">
					...
					<p>
						<input type="checkbox" id="import-settings" name="import_settings" value="1" checked /> <?php _e( 'Theme Settings', 'dynamik' ); ?> <input style="float:right; width:200px;" name="custom_import_file" type="file" />
					</p>
					<p>
					...
					<p>
						<input type="checkbox" id="import-hooks" name="import_hooks" value="1" checked /> <?php _e( 'Custom Hook Boxes', 'dynamik' ); ?> <input type="submit" name="clicked_button" value="<?php _e( 'Import Custom Options', 'dynamik' ); ?>" style="margin:-5px 0 0 !important; float:right !important;" class="button-highlighted button"/>
	...
	<?php if( defined( 'GENEXT_VERSION' ) ) { ?>
		...
		<div class="dynamik-optionbox-inner-1col">
			...
			<div style="width:792px; float:left; padding:10px 10px 10px 0;">
				<div style="width:50%; float:left;">
					<form method="post">
					<div class="bg-box" style="margin-right:0; margin-bottom:0; height:279px;">
