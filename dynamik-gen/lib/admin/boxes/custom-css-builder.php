...
<div style="display:none;" id="dynamik-custom-css-builder" class="dynamik-optionbox-outer-1col">
	<div class="dynamik-optionbox-inner-1col">
		<h3 style="border-bottom:0;"><?php _e( 'Custom CSS Builder', 'dynamik' ); ?> <span id="custom-css-builder-tooltip" class="tooltip-mark tooltip-bottom-center">[?]</span></h3>
		
		<div class="tooltip tooltip-600">
			<h5><?php _e( 'A CSS Building Tool', 'dynamik' ); ?></h5>
			
			<p>
				<?php _e( 'The Custom CSS Builder is a great little tool that can be used as a simple reference or a full blown CSS coding factory.', 'dynamik' ); ?>
			</p>
			
			<h5><?php _e( '#Custom CSS For Your Fonts', 'dynamik' ); ?></h5>
				
			<p>
				<?php _e( 'You\'ll find that most of the font options have a #Custom button to the right. When clicked a textarea will slide down. Here you can add any font styling you like and it will be applied to that font type in the dynamik stylesheet. You will see that the exact CSS ID/class that will be effected is shown at the top of each textarea. And don\'t forget that if you need any CSS assistance the Custom CSS Builder is only a mouse click away!', 'dynamik' ); ?>
				<center><img src="<?php echo CHILD_URL ?>/lib/css/images/tooltips/tooltip-custom-buttons.png" width="549" height="186"/></center>
			</p>
		</div>
		...
		<form name="form">
			<div id="dynamik-custom-css-builder-wrap-inner" class="bg-box">
				...
				<div id="css-builder-output-wrap">
					...
					<input id="css-builder-output-insert" class="button" type="button" value="Click To Insert Into Custom CSS Editor &raquo;">
