	...
	<div class="dynamik-optionbox-inner-1col">
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-heading-font-size" name="dynamik[comment_heading_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_heading_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-heading-font-css-child" id="dynamik-comment-heading-font-css" name="dynamik[comment_heading_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_heading_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-author-font-size" name="dynamik[comment_author_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_author_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-author-font-css" name="dynamik[comment_author_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_author_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-meta-font-css" name="dynamik[comment_meta_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_meta_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Type', 'dynamik' ); ?> <select class="dynamik-universal-font-type-child dynamik-universal-content-font-type-child" id="dynamik-comment-reply-text-font-type" name="dynamik[font_type][comment_reply_text]" size="1" style="width:98px;">
				<?php dynamik_build_font_menu( $dynamik_font_type['comment_reply_text'] ); ?></select>
				<input type="text" id="dynamik-comment-reply-text-font-size" name="dynamik[comment_reply_text_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_font_size' ); ?>" style="width:35px;">
				<code class="dynamik-universal-px-em-child" id="dynamik-comment-reply-text-px-em"><?php echo $px_em_unit_text; ?></code>
				<input type="checkbox" class="universal-check" id="dynamik-comment-reply-text-font-universal" name="dynamik[comment_reply_text_font_u]" value="u" <?php if( checked( 'u', dynamik_get_design( 'comment_reply_text_font_u' ) ) ); ?> /> <?php _e( '(U)', 'dynamik' ); ?>
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-reply-text-font-css" name="dynamik[comment_reply_text_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_reply_text_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Link', 'dynamik' ); ?><input type="text" class="dynamik-universal-link-color-child color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-link-color" name="dynamik[comment_reply_text_link_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_link_color' ); ?>" />
				<?php _e( 'Link Hover', 'dynamik' ); ?><input type="text" class="dynamik-universal-link-hover-color-child color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-link-hover-color" name="dynamik[comment_reply_text_link_hover_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_link_hover_color' ); ?>" />
				<?php _e( 'Link Underline', 'dynamik' ); ?> <select class="dynamik-universal-link-underline-child" id="dynamik-comment-reply-text-link-underline" name="dynamik[comment_reply_text_link_underline]" size="1" style="width:90px;">
				...
				<input type="checkbox" class="universal-check" id="dynamik-comment-reply-text-link-universal" name="dynamik[comment_reply_text_link_u]" value="u" <?php if( checked( 'u', dynamik_get_design( 'comment_reply_text_link_u' ) ) ); ?> /> <?php _e( '(U)', 'dynamik' ); ?>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-body-font-size" name="dynamik[comment_body_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_body_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-body-font-css" name="dynamik[comment_body_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_body_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-form-font-size" name="dynamik[comment_form_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_form_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-form-font-css" name="dynamik[comment_form_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_form_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-submit-font-size" name="dynamik[comment_submit_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_submit_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-submit-font-css" name="dynamik[comment_submit_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_submit_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-form-allowed-tags-font-size" name="dynamik[comment_form_allowed_tags_font_size]" value="<?php dynamik_design_options_defaults( true, 'comment_form_allowed_tags_font_size' ); ?>" style="width:35px;" />
				...
				<textarea class="dynamik-custom-font-css dynamik-universal-font-css-child dynamik-universal-content-font-css-child" id="dynamik-comment-form-allowed-tags-font-css" name="dynamik[comment_form_allowed_tags_font_css]" style="width:100%;" rows="10"><?php echo dynamik_get_design( 'comment_form_allowed_tags_font_css' ); ?></textarea>
				</div>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Type', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-bg-type" class="dynamik-bg-type" name="dynamik[comment_reply_text_bg_type]" size="1" style="width:150px;">
				<?php dynamik_list_bg_options( dynamik_get_design( 'comment_reply_text_bg_type' ) ); ?>
				</select> <span style="display:none;" id="dynamik-comment-reply-text-bg-type-checkbox"><?php _e( '(No Color', 'dynamik' ); ?> <input type="checkbox" id="dynamik-comment-reply-text-bg-no-color" name="dynamik[comment_reply_text_bg_no_color]" value="1" <?php if( checked( 1, dynamik_get_design( 'comment_reply_text_bg_no_color' ) ) ); ?> />)</span><input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-bg-color" name="dynamik[comment_reply_text_bg_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_bg_color' ); ?>" />
				<?php _e( 'Image', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-bg-image" name="dynamik[comment_reply_text_bg_image]" size="1" style="width:150px;"><?php dynamik_list_images( dynamik_get_design( 'comment_reply_text_bg_image' ) ); ?></select>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Type', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-hover-bg-type" class="dynamik-bg-type" name="dynamik[comment_reply_text_hover_bg_type]" size="1" style="width:150px;">
				<?php dynamik_list_bg_options( dynamik_get_design( 'comment_reply_text_hover_bg_type' ) ); ?>
				</select> <span style="display:none;" id="dynamik-comment-reply-text-hover-bg-type-checkbox"><?php _e( '(No Color', 'dynamik' ); ?> <input type="checkbox" id="dynamik-comment-reply-text-hover-bg-no-color" name="dynamik[comment_reply_text_hover_bg_no_color]" value="1" <?php if( checked( 1, dynamik_get_design( 'comment_reply_text_hover_bg_no_color' ) ) ); ?> />)</span><input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-hover-bg-color" name="dynamik[comment_reply_text_hover_bg_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_hover_bg_color' ); ?>" />
				<?php _e( 'Image', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-hover-bg-image" name="dynamik[comment_reply_text_hover_bg_image]" size="1" style="width:150px;"><?php dynamik_list_images( dynamik_get_design( 'comment_reply_text_hover_bg_image' ) ); ?></select>
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<input type="text" id="dynamik-comment-body-border-thickness" name="dynamik[comment_body_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_body_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-comment-list-border-thickness" name="dynamik[comment_list_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_list_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
				<?php _e( 'Style', 'dynamik' ); ?> <select id="dynamik-comment-list-border-style" name="dynamik[comment_list_border_style]" size="1" style="width:80px; margin-right:5px;">
					<?php dynamik_list_borders( dynamik_get_design( 'comment_list_border_style' ) ); ?>
				</select>
				<?php _e( 'Color', 'dynamik' ); ?> <input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-list-border-color" name="dynamik[comment_list_border_color]" value="<?php dynamik_design_options_defaults( true, 'comment_list_border_color' ); ?>" />
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-comment-reply-text-border-thickness" name="dynamik[comment_reply_text_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
				<?php _e( 'Style', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-border-style" name="dynamik[comment_reply_text_border_style]" size="1" style="width:80px; margin-right:5px;">
					<?php dynamik_list_borders( dynamik_get_design( 'comment_reply_text_border_style' ) ); ?>
				</select>
				<?php _e( 'Color', 'dynamik' ); ?> <input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-border-color" name="dynamik[comment_reply_text_border_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_border_color' ); ?>" />
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				...
				<?php _e( 'Thickness', 'dynamik' ); ?> <input type="text" id="dynamik-comment-reply-text-hover-border-thickness" name="dynamik[comment_reply_text_hover_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_hover_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
				<?php _e( 'Style', 'dynamik' ); ?> <select id="dynamik-comment-reply-text-hover-border-style" name="dynamik[comment_reply_text_hover_border_style]" size="1" style="width:80px; margin-right:5px;">
					<?php dynamik_list_borders( dynamik_get_design( 'comment_reply_text_hover_border_style' ) ); ?>
				</select>
				<?php _e( 'Color', 'dynamik' ); ?> <input type="text" class="color {pickerFaceColor:'#FFFFFF'} color-box" id="dynamik-comment-reply-text-hover-border-color" name="dynamik[comment_reply_text_hover_border_color]" value="<?php dynamik_design_options_defaults( true, 'comment_reply_text_hover_border_color' ); ?>" />
			</p>
		</div>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-comment-avatar-border-thickness" name="dynamik[comment_avatar_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_avatar_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-comment-form-border-thickness" name="dynamik[comment_form_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_form_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-comment-submit-border-thickness" name="dynamik[comment_submit_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_submit_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-comment-submit-hover-border-thickness" name="dynamik[comment_submit_hover_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_submit_hover_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
		...
		<div class="dynamik-design-option">
			<p class="bg-box-design">
				<?php _e( 'Thickness', 'dynamik' ); ?>
				<input type="text" id="dynamik-comment-form-allowed-tags-border-thickness" name="dynamik[comment_form_allowed_tags_border_thickness]" value="<?php dynamik_design_options_defaults( true, 'comment_form_allowed_tags_border_thickness' ); ?>" style="width:35px;" /><code class="dynamik-px-unit">px</code>
