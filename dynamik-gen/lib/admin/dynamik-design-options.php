...
function dynamik_design_options_defaults( $defaults = true, $option_check = false, $import = false )
{
	$defaults = array(
		...
		'universal_link_color' => '0037B4',
		'universal_link_hover_color' => '000000',
		'universal_link_underline' => 'Never',
		...
		'comment_reply_text_font_u' => ( $defaults || !empty( $import['comment_reply_text_font_u'] ) ) ? 'u' : 0,
		'comment_reply_text_link_u' => ( $defaults || !empty( $import['comment_reply_text_link_u'] ) ) ? 'u' : 0,
		...
		'font_type' => array(
			...
			'universal_heading' => 'Lato, sans-serif',
			'universal_content' => '\'PT Sans\', sans-serif',
			'title' => 'Lato, sans-serif',
			'tagline' => '\'PT Sans\', sans-serif',
			'nav1' => '\'PT Sans\', sans-serif',
			'nav1_extras' => '\'PT Sans\', sans-serif',
			'nav2' => '\'PT Sans\', sans-serif',
			'nav3' => '\'PT Sans\', sans-serif',
			'content_heading' => 'Lato, sans-serif',
			'content_byline' => '\'PT Sans\', sans-serif',
			'content_p' => '\'PT Sans\', sans-serif',
			'blockquote' => '\'PT Sans\', sans-serif',
			'caption' => '\'PT Sans\', sans-serif',
			'post_meta' => '\'PT Sans\', sans-serif',
			'comment_heading' => 'Lato, sans-serif',
			'comment_author' => '\'PT Sans\', sans-serif',
			'comment_meta' => '\'PT Sans\', sans-serif',
			'comment_reply_text' => '\'PT Sans\', sans-serif',
			'comment_body' => '\'PT Sans\', sans-serif',
			'comment_form' => '\'PT Sans\', sans-serif',
			'comment_submit' => '\'PT Sans\', sans-serif',
			'comment_form_allowed_tags' => '\'PT Sans\', sans-serif',
			'sb_heading' => 'Lato, sans-serif',
			'sb_content' => '\'PT Sans\', sans-serif',
			'footer' => '\'PT Sans\', sans-serif',
			'ez_widget_home_title' => 'Lato, sans-serif',
			'ez_widget_home_content' => '\'PT Sans\', sans-serif',
			'ez_widget_feature_title' => 'Lato, sans-serif',
			'ez_widget_feature_content' => '\'PT Sans\', sans-serif',
			'ez_widget_footer_title' => 'Lato, sans-serif',
			'ez_widget_footer_content' => '\'PT Sans\', sans-serif',
			'featured_widget_heading' => 'Lato, sans-serif',
			'featured_widget_p' => '\'PT Sans\', sans-serif',
			'featured_widget_byline' => '\'PT Sans\', sans-serif',
			'dynamik_widget_title' => 'Lato, sans-serif',
			'dynamik_widget_content' => '\'PT Sans\', sans-serif',
			'search_form' => '\'PT Sans\', sans-serif',
			'search_button' => '\'PT Sans\', sans-serif',
			'breadcrumbs' => '\'PT Sans\', sans-serif',
			'taxonomy_box_heading' => 'Lato, sans-serif',
			'taxonomy_box_content' => '\'PT Sans\', sans-serif',
			'author_box_title' => 'Lato, sans-serif',
			'author_box' => '\'PT Sans\', sans-serif',
			'post_nav' => '\'PT Sans\', sans-serif'
		)
	);
