...
?>
	<div class="wrap">
		...
		?>
			<script type="text/javascript">jQuery(document).ready(function($){ $('#dynamik-custom-saved').html('Custom Options Reset').center().fadeIn('slow');window.setTimeout(function(){$('#dynamik-custom-saved').fadeOut( 'slow' );}, 2222); });</script>
		<?php
		}
		...
		<div id="dynamik-admin-wrap">
			...
			<div id="dynamik-admin-footer">
				<p>
					...
					<a><span id="show-options-reset" class="dynamik-custom-fonts-button button" style="margin:0; float:none !important;"><?php _e( 'Custom Options Reset', 'dynamik' ); ?></span></a>
				</p>
			</div>
			...
			<div style="display:none; position:inherit; height:25px; width:520px; margin:-11px 0 0 135px; float:left;" id="show-options-reset-box" class="dynamik-custom-fonts-box">
				<form style="width:520px; float:left;" id="dynamik-reset-custom-options" method="post">
					<strong><?php _e( '**This Will Reset ALL Your Dynamik Custom Options**', 'dynamik' ); ?></strong>
...
//end lib/admin/dynamik-custom-options.php